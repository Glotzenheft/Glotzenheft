...
/**
 * TvSeasonChangesById200ResponseChangesInnerItemsInnerValue Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeasonChangesById200ResponseChangesInnerItemsInnerValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_season_changes_by_id_200_response_changes_inner_items_inner_value';
    ...
    {
        $this->setIfExists('episode_id', $data ?? [], 0);
    ...
    {
        return $this->container['episode_id'];
    }

    /**
     * Sets episode_id
     *
     * @param int|null $episode_id episode_id
     *
     * @return self
     */
    public function setEpisodeId($episode_id)
    {
        if (is_null($episode_id)) {
            throw new \InvalidArgumentException('non-nullable episode_id cannot be null');
        }
        $this->container['episode_id'] = $episode_id;
