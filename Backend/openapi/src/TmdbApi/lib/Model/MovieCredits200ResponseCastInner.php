...
/**
 * MovieCredits200ResponseCastInner Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class MovieCredits200ResponseCastInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'movie_credits_200_response_cast_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cast_id', $data ?? [], 0);
     ...
     * Sets cast_id
     *
     * @param int|null $cast_id cast_id
     *
     * @return self
     */
    ...
    {
        if (is_null($cast_id)) {
            throw new \InvalidArgumentException('non-nullable cast_id cannot be null');
        }
