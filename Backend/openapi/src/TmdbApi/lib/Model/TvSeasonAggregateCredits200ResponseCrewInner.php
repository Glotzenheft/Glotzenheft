...
/**
 * TvSeasonAggregateCredits200ResponseCrewInner Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeasonAggregateCredits200ResponseCrewInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_season_aggregate_credits_200_response_crew_inner';
    ...
    protected static $openAPITypes = [
        ...
        'popularity' => 'float',
        'profile_path' => 'mixed',
        'jobs' => '\App\TmdbApi\Model\TvSeasonAggregateCredits200ResponseCrewInnerJobsInner[]',
        'department' => 'string',
    ...
    protected static $setters = [
        ...
        'total_episode_count' => 'setTotalEpisodeCount'
    ];
    ...
    protected static $getters = [
        ...
        'total_episode_count' => 'getTotalEpisodeCount'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_episode_count', $data ?? [], 0);
    }
     ...
     * Gets jobs
     *
     * @return \App\TmdbApi\Model\TvSeasonAggregateCredits200ResponseCrewInnerJobsInner[]|null
     */
     ...
     * Sets jobs
     *
     * @param \App\TmdbApi\Model\TvSeasonAggregateCredits200ResponseCrewInnerJobsInner[]|null $jobs jobs
     *
     * @return self
     */
    ...
    /**
     * Gets total_episode_count
     *
     * @return int|null
     */
    public function getTotalEpisodeCount()
    {
        return $this->container['total_episode_count'];
    }

    /**
     * Sets total_episode_count
     *
     * @param int|null $total_episode_count total_episode_count
     *
     * @return self
     */
    public function setTotalEpisodeCount($total_episode_count)
    {
        if (is_null($total_episode_count)) {
            throw new \InvalidArgumentException('non-nullable total_episode_count cannot be null');
        }
        $this->container['total_episode_count'] = $total_episode_count;
