...
/**
 * CollectionImages200ResponseBackdropsInner Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class CollectionImages200ResponseBackdropsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'collection_images_200_response_backdrops_inner';
     ...
     * Sets iso_639_1
     *
     * @param mixed|null $iso_639_1 iso_639_1
     *
     * @return self
     */
    public function setIso6391($iso_639_1)
    {
        if (is_null($iso_639_1)) {
            array_push($this->openAPINullablesSetToNull, 'iso_639_1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('iso_639_1', $nullablesSetToNull);
            if ($index !== FALSE) {
