...
class TvSeasonDetails200ResponseEpisodesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('episode_type', $data ?? [], null);
    ...
    {
        return $this->container['episode_type'];
    }

    /**
     * Sets episode_type
     *
     * @param string|null $episode_type episode_type
     *
     * @return self
     */
    public function setEpisodeType($episode_type)
    {
        if (is_null($episode_type)) {
            throw new \InvalidArgumentException('non-nullable episode_type cannot be null');
        }
        $this->container['episode_type'] = $episode_type;
