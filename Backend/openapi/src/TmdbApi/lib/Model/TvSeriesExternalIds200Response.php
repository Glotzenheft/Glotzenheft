...
/**
 * TvSeriesExternalIds200Response Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeriesExternalIds200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_series_external_ids_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tvdb_id', $data ?? [], 0);
     ...
     * Sets tvdb_id
     *
     * @param int|null $tvdb_id tvdb_id
     *
     * @return self
     */
    ...
    {
        if (is_null($tvdb_id)) {
            throw new \InvalidArgumentException('non-nullable tvdb_id cannot be null');
        }
