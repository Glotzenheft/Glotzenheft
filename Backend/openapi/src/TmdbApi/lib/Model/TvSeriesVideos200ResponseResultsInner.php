...
/**
 * TvSeriesVideos200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeriesVideos200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_series_videos_200_response_results_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('official', $data ?? [], true);
