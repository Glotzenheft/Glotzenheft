...
/**
 * ExternalIdsModel Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class ExternalIdsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'external_ids_model';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tvdb_id', $data ?? [], null);
