...
class MovieDetails200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'belongs_to_collection' => '\App\TmdbApi\Model\MovieDetails200ResponseBelongsToCollection',
        'budget' => 'int',
        ...
        'vote_average' => 'float',
        'vote_count' => 'int',
        'external_ids' => '\App\TmdbApi\Model\ExternalIdsModel'
    ];
    ...
    {
        $this->setIfExists('adult', $data ?? [], false);
        ...
        $this->setIfExists('video', $data ?? [], false);
     ...
     *
     * @return \App\TmdbApi\Model\MovieDetails200ResponseBelongsToCollection|null
     */
     ...
     *
     * @param \App\TmdbApi\Model\MovieDetails200ResponseBelongsToCollection|null $belongs_to_collection belongs_to_collection
     *
     * @return self
     */
    public function setBelongsToCollection($belongs_to_collection)
    {
        if (is_null($belongs_to_collection)) {
            throw new \InvalidArgumentException('non-nullable belongs_to_collection cannot be null');
        }
     ...
     * Gets external_ids
     *
     * @return \App\TmdbApi\Model\ExternalIdsModel|null
     */
     ...
     * Sets external_ids
     *
     * @param \App\TmdbApi\Model\ExternalIdsModel|null $external_ids external_ids
     *
     * @return self
     */
