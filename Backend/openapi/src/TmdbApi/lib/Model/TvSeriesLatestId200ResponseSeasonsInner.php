...
/**
 * TvSeriesLatestId200ResponseSeasonsInner Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeriesLatestId200ResponseSeasonsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_series_latest_id_200_response_seasons_inner';
     ...
     * Sets air_date
     *
     * @param mixed|null $air_date air_date
     *
     * @return self
     */
    ...
    {
        if (is_null($air_date)) {
            array_push($this->openAPINullablesSetToNull, 'air_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('air_date', $nullablesSetToNull);
            if ($index !== FALSE) {
