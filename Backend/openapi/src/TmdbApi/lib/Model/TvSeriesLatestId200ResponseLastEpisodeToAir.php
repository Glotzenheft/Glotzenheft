...
/**
 * TvSeriesLatestId200ResponseLastEpisodeToAir Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeriesLatestId200ResponseLastEpisodeToAir implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_series_latest_id_200_response_last_episode_to_air';
     ...
     * Sets runtime
     *
     * @param mixed|null $runtime runtime
     *
     * @return self
     */
     ...
     * Sets still_path
     *
     * @param mixed|null $still_path still_path
     *
     * @return self
     */
    public function setStillPath($still_path)
    {
        if (is_null($still_path)) {
            array_push($this->openAPINullablesSetToNull, 'still_path');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('still_path', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
