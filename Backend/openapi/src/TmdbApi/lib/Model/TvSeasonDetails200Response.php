...
/**
 * TvSeasonDetails200Response Class Doc Comment
 *
 * @category Class
 * @package  App\TmdbApi
 * @author   OpenAPI Generator team
 ...
 */
class TvSeasonDetails200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tv_season_details_200_response';
    ...
    protected static $openAPITypes = [
        'string_id' => 'string',
        'air_date' => 'string',
        'episodes' => '\App\TmdbApi\Model\TvSeasonDetails200ResponseEpisodesInner[]',
        'name' => 'string',
    ...
    {
        $this->setIfExists('string_id', $data ?? [], null);
     ...
     * Sets string_id
     *
     * @param string|null $string_id string_id
     *
     * @return self
     */
    public function setStringId($string_id)
    {
        if (is_null($string_id)) {
            throw new \InvalidArgumentException('non-nullable string_id cannot be null');
        }
     ...
     * Gets episodes
     *
     * @return \App\TmdbApi\Model\TvSeasonDetails200ResponseEpisodesInner[]|null
     */
     ...
     * Sets episodes
     *
     * @param \App\TmdbApi\Model\TvSeasonDetails200ResponseEpisodesInner[]|null $episodes episodes
     *
     * @return self
     */
