...
readonly class MediaDetailDataDto
{
    ...
    ): self
    {
        ...
        return new self(
            ...
            tvdbId: $media->getTvdbId(),
            wikidataId: $media->getWikidataId(),
            facebookId: $media->getFacebookId(),
            instagramId: $media->getInstagramId(),
            twitterId: $media->getTwitterId(),
            ...
            adult: $media->isAdult(),
            numberOfEpisodes: $media->getNumberOfEpisodes(),
            ...
            budget: $media->getBudget(),
            revenue: $media->getRevenue(),
            seasons: $seasonDtos,
