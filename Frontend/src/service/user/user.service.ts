...
import { LoginAndMessageResponse, LoginCredentials, RegisterCredentials, ResetPasswordCredentials } from '../../app/shared/interfaces/login';
import { ROUTE_DELETE_USER_ACCOUNT, ROUTE_LOGIN, ROUTE_RESET_PASSWORD, ROUTE_STATISTIC_GET_WATCHTIME_PER_DAY, ROUTE_STATISTICS_GET_USER_RATINGS, ROUTE_USER_ACTIVITIES } from '../../app/shared/variables/api-routes';
import { ERR_OBJECT_INVALID_AUTHENTICATION, getMessageObject } from '../../app/shared/variables/message-vars';
import { ROUTES_LIST } from '../../app/shared/variables/routes-list';
import { KEY_LOCAL_STORAGE_LAST_LOG_IN, KEY_LOCAL_STORAGE_LOG_IN_TRIES } from '../../app/shared/variables/local-storage-keys';
