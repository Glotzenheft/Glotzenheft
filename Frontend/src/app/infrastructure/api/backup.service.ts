...
export class R_BackupHttp implements I_BackupRepository {
    ...
    public getBackups = (): Observable<I_Backup[]> => {
        ...
        return this.http
            .get<I_Backup[]>(ROUTE_BACKUP, { headers: headers })
            .pipe(shareReplay(1));
    };
    ...
    public createBackup = (): Observable<void> => {
        ...
        if (!headers) return EMPTY;
        return this.http
            .post<void>(ROUTE_BACKUP, {}, { headers: headers })
            .pipe(shareReplay(1));
    };
    ...
    public uploadBackup = (file: File): Observable<any> => {
        ...
        return this.http
            .post(ROUTE_BACKUP_IMPORT, formData, {
                headers: headers,
                reportProgress: true,
                observe: 'events',
            })
    ...
    public downloadBackup = (backupId: number): Observable<Blob> => {
        ...
        return this.http
            ...
            .pipe(throttleTime(REQUEST_THROTTLE_TIME), shareReplay(1));
    };
}
